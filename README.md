# Note Taker-
This is a project that takes notes and stores them into a database and deploys to its own server using express.js and heroku!
...
<img src="./notetaker.jpg">

 I wanted to create an easy way to create, read, update and delete notes from a database!  

Here's why its awesome:
* You can make new notes
* You can read your new notes
...
You can use this app to write and store your notes!
